...
/***/ function(module, exports, __webpack_require__) {
	...
	var Main = React.createClass({
		...
		setParam: function setParam(parameters) {
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								'em',
								null,
								'Search for articles from The NYT Newspaper.'
							)
						)
					),
					React.createElement(
						...
						React.createElement(Search, { setParam: this.setParam })
					)
				),
				React.createElement(
					'div',
					...
					React.createElement(
						'div',
						{ className: 'col-md-8 col-md-offset-2' },
						React.createElement(Results, { article: this.state.results })
					)
				),
				React.createElement(
					'div',
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement("input", { type: "text", className: "form-control text-center", id: "query", placeholder: "Recent News", onChange: this.handleChange, required: true }),
							...
							React.createElement("input", { type: "text", className: "form-control text-center", id: "startDate", placeholder: "YYYYMMDD", onChange: this.handleChange, required: true }),
							React.createElement("br", null),
							React.createElement(
								"h4",
								{ className: "" },
							...
							React.createElement("input", { type: "text", className: "form-control text-center", id: "endDate", placeholder: "YYYYMMDD", onChange: this.handleChange, required: true }),
							React.createElement("br", null),
							React.createElement(
								"button",
